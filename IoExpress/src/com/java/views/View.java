 ...
 * @Author: YNB
 * @Description:
 * @Date Created in 2020-09-03 19:09
 * @Modified By:
 */
public class View {
    ...
    public   void printAll(Express es,int i){

        if(i == 0){
            nullExpress();
        }else{
            System.out.println("快递的位置是："+i);
            printExpress(es);
        }
    }
    ...
    public  void printExpress(Express es) {
        ...
        System.out.println("快递单号是："+es.getId()+",快递公司是："+es.getCompany()+",取件码是："+es.getCode());
    }

    public  void printIoExpress(String id,String company,String code ){
        System.out.println("快递信息如下：");
        System.out.println("快递单号是："+id+",快递公司是："+company+",取件码是："+code);
    }
